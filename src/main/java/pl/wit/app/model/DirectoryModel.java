...
public class DirectoryModel {
	...
	public DirectoryModel(String sourceDir, String destinationDir) {
		...
		if (!this.sourceDir.exists() || !this.destinationDir.exists()) {
			String folder = this.destinationDir.exists() ? "źródłowy" : "docelowy";
	...
	public void setSourceDir(String sourceDirPath) {
		...
		if (!sourceDi.exists()) {
			throw new IllegalArgumentException("Folder źródłowy nie istnieje");
		}
	...
	public void setDestinationDir(String destinationDirPath) {
		...
		if (!destinationD.exists()) {
			throw new IllegalArgumentException("Folder docelowy nie istnieje");
		}
